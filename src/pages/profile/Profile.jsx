...
// ------- IMAGE -------
import baner from '../../assets/banner3.jpg';
  ...
  return (
    <div className='profiles section__padding'>
      ...
      <div className="banner-use-box">
        ...
        <button className="hiden-edit"><HiOutlinePencil className='bx bx-pencil'></HiOutlinePencil></button>
        </div>
            ...
            <div>
                <p className="chain">
                    <svg width="15px" height="15px" viewBox="0 0 101 88" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <defs>
                            <linearGradient id="paint0_linear_174_4403" x1="8.52558" y1="90.0973" x2="88.9933"
                                y2="-3.01622" gradientUnits="userSpaceOnUse">
      ...
      <tbody>
        ...
        <section className="information">
            <div className="information-option">
                <ul>
                    <li onclick="showPage(1)" class="active">Items Collected <p>0</p></li>
                    <li onclick="showPage(2)">Offers made</li>
                    <li onclick="showPage(3)">Deals</li>
                    <li onclick="showPage(4)">Favorited</li>
                    <li onclick="showPage(5)">Created <p>7 Ss</p></li>
            ...
            <div className="collected-box">
                <div className="collected">
                    <button className="sliders"><i className="fa-solid fa-sliders fa-rotate-270"></i></button>
                    <button className="Status"><Link to={""}>Status</Link> <i className='bx bx-chevron-down Status-dow'></i></button>
                    ...
                    <button className="Recently-created"><Link to={""}>Recently created</Link><i
                            className='bx bx-chevron-down recently'></i></button>
                </div>
                <div>
                </div>
            </div>
            ...
            <div className="collected-box">
                <div className="collected">
                    <button className="collected-filter"><IoFilter></IoFilter></button>
                    <button className="Status"> <Link to={''}>Type</Link><FaAngleDown className='Status-dow'></FaAngleDown></button>       
                    <button className="Status"> <Link to={''}>Status</Link><FaAngleDown className='Status-dow'></FaAngleDown></button>           
                </div>
                <div>
            ...
            <div className="collected-box">
                <div className="collected1">
                    ...
                    <button className="Status1"> <Link to={''}>All Deals</Link><FaAngleDown className='Status-dow'></FaAngleDown></button>       
                    <button className="Status1"> <Link to={''}>Most Recent</Link><FaAngleDown className='Status-dow'></FaAngleDown></button>
                    <div className="collected-make-deal-box">           
                    <button className="collected-make-deal"> <Link to={''}>Make a deal</Link> </button>
                    </div>
                </div>
                <div>
                    ...
                    <div className="favorite-item-box">
                        ...
                        <div className="favorite-item-title">
                            <Link to={''}>
                                <h2>Name</h2>
                                <h3>Name Album</h3>
                                <span><p>1,202 SOL</p>|<p>Last sale: 1,01</p></span>
                            </Link>
                        </div>
                        <div className="favorite-item-title-buy">
                            <button><Link to={''}>Buy now</Link><BiCartDownload></BiCartDownload></button>
                        </div>
                    </div>
                </div>
